...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.get.user' => 'getApp_Get_UserService',
    ...
    /**
     * Gets the 'app.get.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WebSite\AppBundle\Services\User A WebSite\AppBundle\Services\User instance
     */
    protected function getApp_Get_UserService()
    {
        return $this->services['app.get.user'] = new \WebSite\AppBundle\Services\User($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('pXopXhYj2l', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ftGlzJAKTE', 0, '5-MSAd0lx39M2STaMQtalj', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'traveler_test', 'user' => 'root', 'password' => 'lipe', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/WebSite/AppBundle/Entity'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'WebSite\\AppBundle\\Entity');
        $c->addDriver($b, 'Symfony\\Bundle\\WebProfilerBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('WebSiteAppBundle' => 'WebSite\\AppBundle\\Entity', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c67945cce4d6df537108ec76496f9e9ee66e78da86cf79490184f34acd807518');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('RYUEfBTiMU', NULL, '5-MSAd0lx39M2STaMQtalj', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['security.firewall.map.context.dev'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('dev', 'security.request_matcher.5314eeb91110adf24b9b678372bb11bbe00e8858c519c088bfb65f525181ad3bf573fd1d', 'security.user_checker', false, '', '', '', '', '', '', array()));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/WebSite/AdminBundle/Resources/views'), 'WebSiteAdmin');
        $instance->addPath(($this->targetDirs[3].'/src/WebSite/AppBundle/Resources/views'), 'WebSiteApp');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a1c264aa593522d22cc7c650e72e11b9432e7627');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lZO0bYrzJs', 0, '5-MSAd0lx39M2STaMQtalj', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58e63dda621997.54056895')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WebSiteAdminBundle' => 'WebSite\\AdminBundle\\WebSiteAdminBundle',
                'WebSiteAppBundle' => 'WebSite\\AppBundle\\WebSiteAppBundle',
            ...
            'secret' => 'a1c264aa593522d22cc7c650e72e11b9432e7627',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'a1c264aa593522d22cc7c650e72e11b9432e7627',
