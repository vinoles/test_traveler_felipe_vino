 ...
 */
class ListApp extends \WebSite\AppBundle\Entity\ListApp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'WebSite\\AppBundle\\Entity\\ListApp' . "\0" . 'name', '' . "\0" . 'WebSite\\AppBundle\\Entity\\ListApp' . "\0" . 'user', '' . "\0" . 'WebSite\\AppBundle\\Entity\\ListApp' . "\0" . 'created', '' . "\0" . 'WebSite\\AppBundle\\Entity\\ListApp' . "\0" . 'activities'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ListApp $proxy) {
